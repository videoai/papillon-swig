...
//------------------------------------------------------------------------------
// Description: 
// This example shows how to use Papillon SDK in CSharp for face-recognition 
//------------------------------------------------------------------------------
    ...
    class Program {
        ...
        public static PResult DoMatch(PDescription description1, PDescription description2, PVerify verify) {
            ...
            if(matchScore.IsVerified()) {
                Console.WriteLine("Passed Authentication '" + description1.GetName() + "' against '" + description2.GetName() + "' score = " + matchScore.GetScore());
            } else {
                Console.WriteLine("Failed Authentication '" + description1.GetName() + "' against '" + description2.GetName() + "' score = " + matchScore.GetScore());
            }
            return PResult.C_OK;
        }
