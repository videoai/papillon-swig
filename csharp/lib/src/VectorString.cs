...
public class VectorString : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<string>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          PapillonPINVOKE.delete_VectorString(swigCPtr);
        }
  ...
  public void Clear() {
    PapillonPINVOKE.VectorString_Clear(swigCPtr);
  }

  public void Add(string x) {
    PapillonPINVOKE.VectorString_Add(swigCPtr, x);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = PapillonPINVOKE.VectorString_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = PapillonPINVOKE.VectorString_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    PapillonPINVOKE.VectorString_reserve(swigCPtr, n);
  }

  public VectorString() : this(PapillonPINVOKE.new_VectorString__SWIG_0(), true) {
  }
  ...
  public VectorString(int capacity) : this(PapillonPINVOKE.new_VectorString__SWIG_2(capacity), true) {
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }

  private string getitemcopy(int index) {
    string ret = PapillonPINVOKE.VectorString_getitemcopy(swigCPtr, index);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private string getitem(int index) {
    string ret = PapillonPINVOKE.VectorString_getitem(swigCPtr, index);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, string val) {
    PapillonPINVOKE.VectorString_setitem(swigCPtr, index, val);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(VectorString values) {
    PapillonPINVOKE.VectorString_AddRange(swigCPtr, VectorString.getCPtr(values));
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Insert(int index, string x) {
    PapillonPINVOKE.VectorString_Insert(swigCPtr, index, x);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, VectorString values) {
    PapillonPINVOKE.VectorString_InsertRange(swigCPtr, index, VectorString.getCPtr(values));
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    PapillonPINVOKE.VectorString_RemoveAt(swigCPtr, index);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    PapillonPINVOKE.VectorString_RemoveRange(swigCPtr, index, count);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Reverse() {
    PapillonPINVOKE.VectorString_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    PapillonPINVOKE.VectorString_Reverse__SWIG_1(swigCPtr, index, count);
    if (PapillonPINVOKE.SWIGPendingException.Pending) throw PapillonPINVOKE.SWIGPendingException.Retrieve();
  }
